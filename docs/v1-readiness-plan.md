...
6. **Gate 1 CPA:** who is the reviewing accountant, and by when? The product owner
   (a crypto-native CPA) has returned a written technical assessment
   (`docs/gate1-report.md` §6, 2026-09-18). **Also decide the *nature* of the
   review** — informal practitioner feedback (what happened) or a formal
   engagement under a professional standard. Only the latter would support
   describing the statements publicly as "CPA-reviewed", and a founder's review
   of their own product is **not independent** either way.
