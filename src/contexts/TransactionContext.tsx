...
import { Transaction, TransactionFormData, TransactionStatus } from '../types/transaction'
...
interface TransactionContextType {
  ...
  approveTransaction: (id: string, approverId: string, approverName: string) => Promise<void>
  rejectTransaction: (id: string, approverId: string, approverName: string, reason: string) => Promise<void>
  pendingApprovals: Transaction[]
}

const TransactionContext = createContext<TransactionContextType | undefined>(undefined)

export const TransactionProvider: React.FC<{ children: ReactNode; userAccountType?: string }> = ({
  children,
  userAccountType = 'individual'
}) => {
  const [transactions, setTransactions] = useState<Transaction[]>([])

  const isTeamAccount = userAccountType === 'sme' || userAccountType === 'not-for-profit'
