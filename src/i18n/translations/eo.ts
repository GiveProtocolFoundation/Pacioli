...
export const eo: Translations = {
  ...
  firstLaunch: {
    welcome: 'Bonvenon al Pacioli',
    selectLanguage: 'Elekti Lingvon',
    selectLanguageDesc: 'Elektu vian preferatan lingvon por la aplikaĵo.',
    ...
    passwordTooShort: 'Pasvorto devas havi almenaŭ 8 signojn',
  ...
  recovery: {
    ...
    resetSuccess: 'Pasvorto sukcese restarigita!',
    resetButton: 'Restarigi Pasvorton',
    backToLogin: 'Reen al ensaluto',
  },

  unlock: {
    title: 'Rebonvenon',
    subtitle: 'Enigu vian pasvorton por malŝlosi Pacioli',
    enterPassword: 'Enigu pasvorton',
    unlock: 'Malŝlosi',
  ...
  dashboard: {
    title: 'Panelo',
    welcome: 'Rebonvenon',
    totalBalance: 'Tuta Bilanco',
    recentTransactions: 'Lastaj Transakcioj',
    wallets: 'Monujoj',
    noWallets: 'Neniuj monujoj ankoraŭ aldonitaj',
    addWallet: 'Aldoni Monujon',
  },
  ...
  settings: {
    ...
    changeSecurityMode: 'Ŝanĝi Sekurecan Reĝimon',
    currentMode: 'Aktuala Reĝimo',
    exportData: 'Eksporti Datumojn',
    importData: 'Importi Datumojn',
    about: 'Pri',
  },
}
